               ...
               try
        {
         ...
         {   
             ...
             if (chooser.showSaveDialog(null)==JFileChooser.APPROVE_OPTION)
             {
                 ...
                 documento.open();
                 documento.add(new Paragraph("DOCUMENTO RESERVA"));
                 ...
                 while(rs.next())
                 {              
                     documento.add(new Paragraph("Fecha Emisión : " + rs.getString("fecha")));
                     documento.add(new Paragraph("Fecha Entrega : " + rs.getString("fecha_entrega")));
